...
/* mcp_queue.html */
class __TwigTemplate_62ef3bd42d1d3c7d11a23e52362f6611c408d18dc68775b9b11e92be68f60f7a extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t\t";
            ...
            if (($context["S_RESTORE"] ?? null)) {
                // line 106
                echo "\t\t<input class=\"button2 button_disapprove\" type=\"submit\" name=\"action[delete]\" value=\"";
                echo $this->extensions['phpbb\template\twig\extension']->lang("DELETE");
                echo "\" />&nbsp;
\t\t<input class=\"button1 button_approve\" type=\"submit\" name=\"action[restore]\" value=\"";
                // line 107
...
\t\t";
                ...
                // line 109
                echo "\t\t<input class=\"button2 button_disapprove\" type=\"submit\" name=\"action[disapprove]\" value=\"";
